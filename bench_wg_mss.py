...
{wg1n_docker_config}EOFCONFIG"""
    ...
    def save_csv(self):
        ...
        filename = f"bench_wg_mss-{self.bench_choice}.csv"
    ...
    def save_txt(self):
        ...
        filename = f"bench_wg_mss-{self.bench_choice}.txt"
    ...
    def generate_graph(self):
        ...
        # Save as PDF
        pdf_filename = f"bench_wg_mss-{self.bench_choice}.pdf"
        plt.savefig(pdf_filename, format='pdf', dpi=300, bbox_inches='tight')
        print(f"Graph saved as {pdf_filename}")
        
        # Save as PNG
        png_filename = f"bench_wg_mss-{self.bench_choice}.png"
