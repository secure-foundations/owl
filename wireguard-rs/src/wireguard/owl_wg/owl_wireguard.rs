...
(parse (parse_owlSpec_transp(c)) as (owlSpec_transp{owlSpec__transp_tag : _unused784 , owlSpec__transp_receiver : from , owlSpec__transp_counter : ctr , owlSpec__transp_packet : pkt }) in {
(parse (transp_keys_val) as (owlSpec_transp_keys{owlSpec__transp_keys_initiator : initiator_name , owlSpec__transp_keys_responder : _unused785 , owlSpec__transp_keys_init_ephemeral : eph_init , owlSpec__transp_keys_resp_ephemeral : _unused786 , owlSpec__transp_keys_T_init_send : i2r_ , owlSpec__transp_keys_T_resp_send : _unused787 }) in {
...
pub open spec fn transp_send_resp_spec(
    ...
    owl_spec!(mut_state,state_Responder,
(parse (transp_keys_val) as (owlSpec_transp_keys{owlSpec__transp_keys_initiator : transp_receiver , owlSpec__transp_keys_responder : _unused865 , owlSpec__transp_keys_init_ephemeral : eph_init , owlSpec__transp_keys_resp_ephemeral : _unused866 , owlSpec__transp_keys_T_init_send : _unused867 , owlSpec__transp_keys_T_resp_send : r2i_ }) in {
let r2i = ((ret (r2i_))) in
...
impl<O> cfg_Initiator<O> {
    ...
    pub fn owl_transp_recv_init(
        ...
        owl_transp_keys_val11336: owl_transp_keys,
        owl_c11335: Arc<Vec<u8>>,
    ) -> (res: Result<
    ...
    >)
        requires
            itree.view() == transp_recv_init_spec(
                *self,
                *old(mut_state),
                owl_transp_keys_val11336.dview(),
                owl_c11335.dview(),
            ),
        ensures
            ...
            ),
    {
        ...
        let res_inner = {
            ...
            let temp_owl__x33 = { arc_clone(&owl_c11335) };
            ...
            if let Some(parseval) = parse_owl_transp(vec_as_slice(&(*arc_clone(&owl__x33)))) {
                ...
                {
                    let temp_owl__x32 = { owl_transp_keys_val11336 };
                    ...
                    {
                        let temp_owl__x28 = { arc_clone(&owl_c11335) };
    ...
    pub fn owl_transp_send_init(
        ...
        mut_state: &mut state_Initiator,
        owl_transp_keys_val9523: owl_transp_keys,
        owl_plaintext9522: Arc<Vec<u8>>,
        obuf: &mut [u8]
    ) -> (res: Result<
    ...
    >)
        requires
            itree.view() == transp_send_init_spec(
                *self,
                *old(mut_state),
                owl_transp_keys_val9523.dview(),
                owl_plaintext9522.dview(),
            ),
        ensures
            res.is_Ok() ==> (res.get_Ok_0().1).view().view().results_in(
                (dview_option(res.get_Ok_0().0), *mut_state),
            ),
    {
        ...
        let res_inner = {
            ...
            let temp_owl__x114 = { owl_transp_keys_val9523 };
            ...
            let owl__40 = arc_new(parseval.owl__transp_keys_T_resp_send);
            {
                ...
                if owl__x113 {
                    ...
                    let temp_owl__x66 = { arc_clone(&owl_plaintext9522) };
    ...
    pub fn owl_receive_msg2(
        ...
        Tracked(itree): Tracked<ITreeToken<(Option<Seq<u8>>, state_Initiator), Endpoint>>,
        mut_state: &mut state_Initiator,
        owl_msg1_val5829: owl_initiator_msg1_val,
        owl_dhpk_S_resp5828: Arc<Vec<u8>>,
        ibuf: &[u8]
    ) -> (res: Result<
        (
    ...
    >)
        requires
            itree.view() == receive_msg2_spec(
                *self,
                *old(mut_state),
                owl_msg1_val5829.dview(),
                owl_dhpk_S_resp5828.dview(),
            ),
        ensures
            res.is_Ok() ==> (res.get_Ok_0().1).view().view().results_in(
            ...
            ),
    {
        ...
        let res_inner = {
            ...
            if let Some(parseval) = parse_owl_msg2(vec_as_slice(&(*arc_clone(&owl__x407)))) {
                ...
                {
                    let temp_owl__x406 = { owl_msg1_val5829 };
    ...
    pub exec fn owl_generate_msg1_wrapper(&self, s: &mut state_Initiator, dhpk_S_resp: Arc<Vec<u8>>, ss_S_resp_S_init: Arc<Vec<u8>>, obuf: &mut [u8]) -> (_: owl_initiator_msg1_val) {
        let tracked dummy_tok: ITreeToken<(), Endpoint> = ITreeToken::<
            (),
            Endpoint,
        >::dummy_itree_token();
        ...
        let (res, _): (owl_initiator_msg1_val, Tracked<ITreeToken<(Seq<u8>, state_Initiator), Endpoint>>) =
            self.owl_generate_msg1(Tracked(call_token), s, dhpk_S_resp, ss_S_resp_S_init, obuf).unwrap();
        res
    }
    ...
    pub fn owl_generate_msg1(
        ...
        mut_state: &mut state_Initiator,
        owl_dhpk_S_resp5817: Arc<Vec<u8>>,
            ...
            ),
    {
        ...
        let res_inner = {
            ...
            let temp_owl__x460 = { arc_clone(&owl_dhpk_S_resp5817) };
            ...
            let owl_msg1_C1746 = owl_extract_expand_to_len(
                0 + nonce_size(),
            ...
            let temp_owl__x483 = {
            arc_new(
                slice_to_vec(slice_subrange(vec_as_slice(&*owl_msg1_C1746), 0, 0 + nonce_size())),
            )
            };
            ...
            let temp_owl__x513 = { arc_clone(&owl_dhpk_S_resp5817) };
            ...
            let owl_msg1_C2747 = owl_extract_expand_to_len(
            ...
            let temp_owl__x526 = {
            arc_new(
                slice_to_vec(slice_subrange(vec_as_slice(&*owl_msg1_C2747), 0, 0 + nonce_size())),
            )
            };
            ...
            let temp_owl__x576 = { arc_clone(&owl__x526) };
            ...
            let owl_msg1_C3748 = owl_extract_expand_to_len(
                0 + nonce_size() + key_size(),
                vec_as_slice(&(*arc_clone(&owl__x576))),
                vec_as_slice(&(*arc_clone(&owl__x578))),
            );
            let temp_owl__x579 = {
            arc_new(
                slice_to_vec(slice_subrange(vec_as_slice(&*owl_msg1_C3748), 0, 0 + nonce_size())),
            )
            };
            let owl__x579 = arc_clone(&temp_owl__x579);
            let temp_owl__x584 = { arc_clone(&owl__x526) };
            let owl__x584 = arc_clone(&temp_owl__x584);
            let temp_owl__x586 = { arc_clone(&owl_ss_S_resp_S_init5816) };
            let owl__x586 = arc_clone(&temp_owl__x586);
            let temp_owl__x587 = {
            arc_new(
                slice_to_vec(
                    slice_subrange(
                        vec_as_slice(&*owl_msg1_C3748),
                        0 + nonce_size(),
                        0 + nonce_size() + key_size(),
                    ),
                ),
            ...
            let (temp_owl__x589, Tracked(itree)): (
                _,
...
, self.owl_timestamp_i(mut_state) )
            ...
            let temp_owl__x595 = { arc_clone(&owl__x587) };
            let owl__x595 = arc_clone(&temp_owl__x595);
            let temp_owl__x597 = { arc_clone(&owl__x589) };
            let owl__x597 = arc_clone(&temp_owl__x597);
            let temp_owl__x599 = { arc_clone(&owl__x571) };
            let owl__x599 = arc_clone(&temp_owl__x599);
            let temp_owl__x600 = {
                match owl_enc_st_aead(
                    vec_as_slice(&(*arc_clone(&owl__x595))),
                    vec_as_slice(&(*arc_clone(&owl__x597))),
            ...
            let temp_owl__x613 = { arc_clone(&owl__x571) };
            let owl__x613 = arc_clone(&temp_owl__x613);
            let temp_owl__x615 = { arc_clone(&owl__x600) };
            ...
            let temp_owl__x619 = { owl_crh(vec_as_slice(&(*arc_clone(&owl__x617)))) };
            let owl__x619 = arc_clone(&temp_owl__x619);
            let temp_owl__x620 = { arc_clone(&owl__x619) };
            let owl__x620 = arc_clone(&temp_owl__x620);
            let (temp_owl__x622, Tracked(itree)): (
                _,
                Tracked<ITreeToken<(Seq<u8>, state_Initiator), Endpoint>>,
            ) = {
                owl_call!( itree
...
, self.owl_get_sender_i(mut_state) )
            ...
            let owl__x622 = arc_clone(&temp_owl__x622);
            let temp_owl__x626 = { owl_msg1_tag_value() };
            let owl__x626 = arc_new(temp_owl__x626);
            let temp_owl__x627 = { arc_clone(&owl__x626) };
            let owl__x627 = arc_clone(&temp_owl__x627);
            let temp_owl__x640 = { owl_mac1() };
            let owl__x640 = arc_new(temp_owl__x640);
            let temp_owl__x642 = { arc_clone(&owl_dhpk_S_resp5817) };
            let owl__x642 = arc_clone(&temp_owl__x642);
            let temp_owl__x644 = {
            owl_concat(
                vec_as_slice(&(*arc_clone(&owl__x640))),
                vec_as_slice(&(*arc_clone(&owl__x642))),
            )
            };
            let owl__x644 = arc_new(temp_owl__x644);
            let temp_owl__x646 = { owl_crh(vec_as_slice(&(*arc_clone(&owl__x644)))) };
            let owl__x646 = arc_clone(&temp_owl__x646);
            let temp_owl__x647 = { arc_clone(&owl__x646) };
            let owl__x647 = arc_clone(&temp_owl__x647);
            let temp_owl__x660 = { arc_clone(&owl__x647) };
            let owl__x660 = arc_clone(&temp_owl__x660);
            let temp_owl__x666 = { arc_clone(&owl__x627) };
            let owl__x666 = arc_clone(&temp_owl__x666);
            let temp_owl__x668 = { arc_clone(&owl__x622) };
            ...
            let owl__x669 = arc_new(temp_owl__x669);
            let temp_owl__x671 = { arc_clone(&owl__x475) };
            ...
            let temp_owl__x674 = { arc_clone(&owl__x551) };
            ...
            let temp_owl__x677 = { arc_clone(&owl__x600) };
            ...
            let temp_owl__x683 = { owl_zeros_16() };
            let owl__x683 = arc_new(temp_owl__x683);
            let temp_owl__x684 = { arc_clone(&owl__x683) };
            let owl__x684 = arc_clone(&temp_owl__x684);
            let temp_owl__x709 = { arc_clone(&owl__x627) };
            let owl__x709 = arc_clone(&temp_owl__x709);
            let temp_owl__x711 = { arc_clone(&owl__x622) };
            let owl__x711 = arc_clone(&temp_owl__x711);
            let temp_owl__x713 = { arc_clone(&owl__x475) };
            let owl__x713 = arc_clone(&temp_owl__x713);
            let temp_owl__x715 = { arc_clone(&owl__x551) };
            let owl__x715 = arc_clone(&temp_owl__x715);
            let temp_owl__x717 = { arc_clone(&owl__x600) };
            let owl__x717 = arc_clone(&temp_owl__x717);
            let temp_owl__x719 = { arc_clone(&owl__x679) };
            let owl__x719 = arc_clone(&temp_owl__x719);
            let temp_owl__x721 = { arc_clone(&owl__x684) };
            let owl__x721 = arc_clone(&temp_owl__x721);
            let temp_owl__x723 = {
            owl_msg1 {
                owl__msg1_tag: clone_vec_u8(&*arc_clone(&owl__x709)),
                owl__msg1_sender: clone_vec_u8(&*arc_clone(&owl__x711)),
                owl__msg1_ephemeral: clone_vec_u8(&*arc_clone(&owl__x713)),
                owl__msg1_static: clone_vec_u8(&*arc_clone(&owl__x715)),
                owl__msg1_timestamp: clone_vec_u8(&*arc_clone(&owl__x717)),
                owl__msg1_mac1: clone_vec_u8(&*arc_clone(&owl__x719)),
                owl__msg1_mac2: clone_vec_u8(&*arc_clone(&owl__x721)),
            }
            };
            let owl__x723 = temp_owl__x723;
            let temp_owl__x724 = { owl__x723 };
            let owl__x724 = temp_owl__x724;
            let temp_owl__x728 = { owl__x724 };
            let owl__x728 = temp_owl__x728;
            let temp_owl__x729 = {
            owl_output::<(Seq<u8>, state_Initiator)>(
                Tracked(&mut itree),
                vec_as_slice(&(serialize_owl_msg1(&owl__x728))),
                &Responder_addr(),
                &Initiator_addr(),
                obuf
            )
            ...
            let temp_owl__x739 = { arc_clone(&owl__x579) };
            let owl__x739 = arc_clone(&temp_owl__x739);
            let temp_owl__x741 = { arc_clone(&owl__x620) };
            let owl__x741 = arc_clone(&temp_owl__x741);
            let temp_owl__x743 = {
            owl_initiator_msg1_val {
                owl__initiator_msg1_C3: clone_vec_u8(&*arc_clone(&owl__x739)),
                owl__initiator_msg1_H4: clone_vec_u8(&*arc_clone(&owl__x741)),
            }
            };
            let owl__x743 = temp_owl__x743;
            let temp_owl__x744 = { owl__x743 };
            let owl__x744 = temp_owl__x744;
            let temp_owl__x745 = { owl__x744 };
            let owl__x745 = temp_owl__x745;
            (owl__x745, Tracked(itree))
        };
        Ok(res_inner)
    }
...
impl<O> cfg_Responder<O> { 
    ...
    pub fn owl_transp_recv_resp(
        ...
        owl_transp_keys_val14555: owl_transp_keys,
        owl_c14554: Arc<Vec<u8>>,
    ) -> (res: Result<
    ...
    >)
        requires
            itree.view() == transp_recv_resp_spec(
                *self,
                *old(mut_state),
                owl_transp_keys_val14555.dview(),
                owl_c14554.dview(),
            ),
        ensures
            res.is_Ok() ==> (res.get_Ok_0().1).view().view().results_in(
            ...
            ),
    {
        ...
        let res_inner = {
            ...
            let temp_owl__x782 = { arc_clone(&owl_c14554) };
            let owl__x782 = arc_clone(&temp_owl__x782);
            if let Some(parseval) = parse_owl_transp(vec_as_slice(&(*arc_clone(&owl__x782)))) {
                let owl__755 = arc_new(parseval.owl__transp_tag);
                let owl_from754 = arc_new(parseval.owl__transp_receiver);
                let owl_ctr753 = arc_new(parseval.owl__transp_counter);
                let owl_pkt752 = arc_new(parseval.owl__transp_packet);
                {
                    let temp_owl__x781 = { owl_transp_keys_val14555 };
                    let owl__x781 = temp_owl__x781;
                    let parseval = owl__x781;
                    let owl_initiator_name761 = arc_new(parseval.owl__transp_keys_initiator);
                    let owl__760 = arc_new(parseval.owl__transp_keys_responder);
                    let owl_eph_init759 = arc_new(parseval.owl__transp_keys_init_ephemeral);
                    let owl__758 = arc_new(parseval.owl__transp_keys_resp_ephemeral);
                    let owl_i2r_757 = arc_new(parseval.owl__transp_keys_T_init_send);
                    let owl__756 = arc_new(parseval.owl__transp_keys_T_resp_send);
                    {
                        let temp_owl__x777 = { arc_clone(&owl_c14554) };
                        let owl__x777 = arc_clone(&temp_owl__x777);
                        let temp_owl__x779 = { arc_clone(&owl_initiator_name761) };
                        let owl__x779 = arc_clone(&temp_owl__x779);
                        let temp_owl__x780 = {
                        rc_vec_eq(&arc_clone(&owl__x777), &arc_clone(&owl__x779))
                        };
                        let owl__x780 = temp_owl__x780;
                        if owl__x780 {
                            let temp_owl__x766 = { arc_clone(&owl_i2r_757) };
                            let owl__x766 = arc_clone(&temp_owl__x766);
                            let temp_owl__x767 = { arc_clone(&owl__x766) };
                            let owl__x767 = arc_clone(&temp_owl__x767);
                            let temp_owl__x770 = { arc_clone(&owl__x767) };
                            let owl__x770 = arc_clone(&temp_owl__x770);
                            let temp_owl__x771 = { arc_clone(&owl_pkt752) };
                            ...
                            let owl__x772 = arc_new(temp_owl__x772);
                            let temp_owl__x773 = { arc_clone(&owl_ctr753) };
                            let owl__x773 = arc_clone(&temp_owl__x773);
                            (
                                owl_dec_st_aead(
                                    vec_as_slice(&(*arc_clone(&owl__x770))),
                                    vec_as_slice(&(*arc_clone(&owl__x771))),
                                    vec_as_slice(&(*arc_clone(&owl__x773))),
                                    vec_as_slice(&(*arc_clone(&owl__x772))),
                                ),
                                Tracked(itree),
                            )
                        } else {
                ...
                let temp_owl__x751 = { None };
                let owl__x751 = temp_owl__x751;
                (owl__x751, Tracked(itree))
            }
        };
        Ok(res_inner)
    }
    ...
    pub fn owl_transp_send_resp(
        ...
        mut_state: &mut state_Responder,
        owl_transp_keys_val12790: owl_transp_keys,
        owl_plaintext12789: Arc<Vec<u8>>,
        obuf: &mut [u8]
    ) -> (res: Result<
    ...
    >)
        requires
            itree.view() == transp_send_resp_spec(
                *self,
                *old(mut_state),
                owl_transp_keys_val12790.dview(),
                owl_plaintext12789.dview(),
            ),
        ensures
            res.is_Ok() ==> (res.get_Ok_0().1).view().view().results_in(
                (dview_option(res.get_Ok_0().0), *mut_state),
            ),
    {
        ...
        let res_inner = {
            ...
            let temp_owl__x863 = { owl_transp_keys_val12790 };
            let owl__x863 = temp_owl__x863;
            let parseval = owl__x863;
            let owl_transp_receiver794 = arc_new(parseval.owl__transp_keys_initiator);
            let owl__793 = arc_new(parseval.owl__transp_keys_responder);
            let owl_eph_init792 = arc_new(parseval.owl__transp_keys_init_ephemeral);
            let owl__791 = arc_new(parseval.owl__transp_keys_resp_ephemeral);
            let owl__790 = arc_new(parseval.owl__transp_keys_T_init_send);
            let owl_r2i_789 = arc_new(parseval.owl__transp_keys_T_resp_send);
            {
                let temp_owl__x799 = { arc_clone(&owl_r2i_789) };
                let owl__x799 = arc_clone(&temp_owl__x799);
                let temp_owl__x800 = { arc_clone(&owl__x799) };
                let owl__x800 = arc_clone(&temp_owl__x800);
                let temp_owl__x802 = { owl_counter_as_bytes(&(mut_state.owl_N_resp_send)) };
                let owl__x802 = arc_new(temp_owl__x802);
                let temp_owl__x806 = { owl_transp_tag_value() };
                let owl__x806 = arc_new(temp_owl__x806);
                let temp_owl__x807 = { arc_clone(&owl__x806) };
                let owl__x807 = arc_clone(&temp_owl__x807);
                let temp_owl__x858 = { arc_clone(&owl_transp_receiver794) };
                let owl__x858 = arc_clone(&temp_owl__x858);
                let temp_owl__x859 = { vec_length(&(*arc_clone(&owl__x858))) };
                let owl__x859 = temp_owl__x859;
                let temp_owl__x861 = { 4 };
                let owl__x861 = temp_owl__x861;
                let temp_owl__x862 = { owl__x859 == owl__x861 };
                let owl__x862 = temp_owl__x862;
                if owl__x862 {
                    let temp_owl__x813 = { arc_clone(&owl__x800) };
                    let owl__x813 = arc_clone(&temp_owl__x813);
                    let temp_owl__x815 = { arc_clone(&owl_plaintext12789) };
                    ...
                    let temp_owl__x818 = {
                        match owl_enc_st_aead(
                            vec_as_slice(&(*arc_clone(&owl__x813))),
                            vec_as_slice(&(*arc_clone(&owl__x815))),
                    ...
                    let temp_owl__x834 = { arc_clone(&owl__x807) };
                    let owl__x834 = arc_clone(&temp_owl__x834);
                    let temp_owl__x836 = { arc_clone(&owl_transp_receiver794) };
                    let owl__x836 = arc_clone(&temp_owl__x836);
                    let temp_owl__x838 = { arc_clone(&owl__x802) };
                    let owl__x838 = arc_clone(&temp_owl__x838);
                    let temp_owl__x840 = { arc_clone(&owl__x818) };
                    let owl__x840 = arc_clone(&temp_owl__x840);
                    let temp_owl__x842 = {
                    owl_transp {
                        owl__transp_tag: clone_vec_u8(&*arc_clone(&owl__x834)),
                        owl__transp_receiver: clone_vec_u8(&*arc_clone(&owl__x836)),
                        owl__transp_counter: clone_vec_u8(&*arc_clone(&owl__x838)),
                        owl__transp_packet: clone_vec_u8(&*arc_clone(&owl__x840)),
                    }
                    };
                    let owl__x842 = temp_owl__x842;
                    let temp_owl__x843 = { owl__x842 };
                    let owl__x843 = temp_owl__x843;
                    let temp_owl__x847 = { owl__x843 };
                    let owl__x847 = temp_owl__x847;
                    let temp_owl__x848 = {
                    owl_output::<(Option<()>, state_Responder)>(
                        Tracked(&mut itree),
                        vec_as_slice(&(serialize_owl_transp(&owl__x847))),
                        &Initiator_addr(),
                        &Responder_addr(),
                        obuf
                    )
                    };
                    let owl__x848 = temp_owl__x848;
                    let temp_owl__x851 = { () };
                    let owl__x851 = temp_owl__x851;
                    let temp_owl__x852 = { Some(owl__x851) };
                    let owl__x852 = temp_owl__x852;
                    (owl__x852, Tracked(itree))
                } else {
                    (None, Tracked(itree))
                }
            }
    ...
    pub fn owl_generate_msg2(
        ...
        mut_state: &mut state_Responder,
        owl_msg1_val_8317: owl_responder_msg1_val,
        obuf: &mut [u8]
    ) -> (res: Result<
    ...
    >)
        requires
            itree.view() == generate_msg2_spec(*self, *old(mut_state), owl_msg1_val_8317.dview()),
        ensures
            res.is_Ok() ==> (res.get_Ok_0().1).view().view().results_in(
                (res.get_Ok_0().0.dview().as_seq(), *mut_state),
            ),
    {
        ...
        let res_inner = {
            ...
            let temp_owl__x1209 = { owl_msg1_val_8317 };
            let owl__x1209 = temp_owl__x1209;
            let temp_owl__x1208 = { owl__x1209 };
            let owl__x1208 = temp_owl__x1208;
            let parseval = owl__x1208;
            let owl_C3877 = arc_new(parseval.owl__responder_msg1_C3);
            let owl_H4876 = arc_new(parseval.owl__responder_msg1_H4);
            let owl_ephemeral_875 = arc_new(parseval.owl__responder_msg1_ephemeral);
            let owl_dhpk_S_init874 = arc_new(parseval.owl__responder_msg1_sender_pk);
            let owl_msg2_receiver873 = arc_new(parseval.owl__responder_msg1_sender);
            {
                let temp_owl__x882 = { arc_clone(&owl_ephemeral_875) };
                let owl__x882 = arc_clone(&temp_owl__x882);
                let temp_owl__x883 = { arc_clone(&owl__x882) };
                let owl__x883 = arc_clone(&temp_owl__x883);
                let temp_owl__x890 = { arc_clone(&self.owl_E_resp) };
                let owl__x890 = arc_clone(&temp_owl__x890);
                let temp_owl__x892 = { owl_dhpk(vec_as_slice(&(*arc_clone(&owl__x890)))) };
                let owl__x892 = arc_clone(&temp_owl__x892);
                let temp_owl__x893 = { arc_clone(&owl__x892) };
                let owl__x893 = arc_clone(&temp_owl__x893);
                let temp_owl__x897 = { owl_zeros_32() };
                let owl__x897 = arc_new(temp_owl__x897);
                let temp_owl__x898 = { arc_clone(&owl__x897) };
                let owl__x898 = arc_clone(&temp_owl__x898);
                let temp_owl__x903 = { arc_clone(&owl_C3877) };
                let owl__x903 = arc_clone(&temp_owl__x903);
                let temp_owl__x905 = { arc_clone(&owl__x893) };
                let owl__x905 = arc_clone(&temp_owl__x905);
                let owl_msg2_C41213 = owl_extract_expand_to_len(
                    0 + nonce_size(),
                    vec_as_slice(&(*arc_clone(&owl__x903))),
                    vec_as_slice(&(*arc_clone(&owl__x905))),
                );
                let temp_owl__x906 = {
                arc_new(
                    slice_to_vec(
                        slice_subrange(vec_as_slice(&*owl_msg2_C41213), 0, 0 + nonce_size()),
                    ),
                )
                };
                let owl__x906 = arc_clone(&temp_owl__x906);
                let temp_owl__x919 = { arc_clone(&owl_H4876) };
                let owl__x919 = arc_clone(&temp_owl__x919);
                let temp_owl__x921 = { arc_clone(&owl__x893) };
                ...
                let owl__x923 = arc_new(temp_owl__x923);
                let temp_owl__x925 = { owl_crh(vec_as_slice(&(*arc_clone(&owl__x923)))) };
                let owl__x925 = arc_clone(&temp_owl__x925);
                let temp_owl__x926 = { arc_clone(&owl__x925) };
                let owl__x926 = arc_clone(&temp_owl__x926);
                let temp_owl__x936 = { arc_clone(&owl__x883) };
                let owl__x936 = arc_clone(&temp_owl__x936);
                let temp_owl__x938 = { arc_clone(&self.owl_E_resp) };
                ...
                let temp_owl__x946 = { arc_clone(&owl__x906) };
                let owl__x946 = arc_clone(&temp_owl__x946);
                let temp_owl__x948 = { arc_clone(&owl__x941) };
                let owl__x948 = arc_clone(&temp_owl__x948);
                let owl_msg2_C51214 = owl_extract_expand_to_len(
                    0 + nonce_size(),
                    vec_as_slice(&(*arc_clone(&owl__x946))),
                    vec_as_slice(&(*arc_clone(&owl__x948))),
                );
                let temp_owl__x949 = {
                arc_new(
                    slice_to_vec(
                        slice_subrange(vec_as_slice(&*owl_msg2_C51214), 0, 0 + nonce_size()),
                    ),
                )
                };
                let owl__x949 = arc_clone(&temp_owl__x949);
                let temp_owl__x956 = { arc_clone(&owl__x949) };
                let owl__x956 = arc_clone(&temp_owl__x956);
                let temp_owl__x959 = { arc_clone(&owl_dhpk_S_init874) };
                let owl__x959 = arc_clone(&temp_owl__x959);
                let temp_owl__x961 = { arc_clone(&self.owl_E_resp) };
                ...
                let owl_msg2_C61215 = owl_extract_expand_to_len(
                    0 + nonce_size(),
                    vec_as_slice(&(*arc_clone(&owl__x956))),
                    vec_as_slice(&(*arc_clone(&owl__x962))),
                );
                let temp_owl__x963 = {
                arc_new(
                    slice_to_vec(
                        slice_subrange(vec_as_slice(&*owl_msg2_C61215), 0, 0 + nonce_size()),
                    ),
                )
                };
                let owl__x963 = arc_clone(&temp_owl__x963);
                let temp_owl__x968 = { arc_clone(&owl__x963) };
                let owl__x968 = arc_clone(&temp_owl__x968);
                let temp_owl__x970 = { arc_clone(&owl__x898) };
                let owl__x970 = arc_clone(&temp_owl__x970);
                let owl_msg2_C71216 = owl_extract_expand_to_len(
                    0 + nonce_size() + nonce_size() + key_size(),
                    vec_as_slice(&(*arc_clone(&owl__x968))),
                    vec_as_slice(&(*arc_clone(&owl__x970))),
                );
                let temp_owl__x971 = {
                arc_new(
                    slice_to_vec(
                        slice_subrange(vec_as_slice(&*owl_msg2_C71216), 0, 0 + nonce_size()),
                    ),
                )
                };
                let owl__x971 = arc_clone(&temp_owl__x971);
                let temp_owl__x976 = { arc_clone(&owl__x963) };
                let owl__x976 = arc_clone(&temp_owl__x976);
                let temp_owl__x978 = { arc_clone(&owl__x898) };
                let owl__x978 = arc_clone(&temp_owl__x978);
                let temp_owl__x979 = {
                arc_new(
                    slice_to_vec(
                        slice_subrange(
                            vec_as_slice(&*owl_msg2_C71216),
                            0 + nonce_size(),
                            0 + nonce_size() + nonce_size(),
                        ),
                    ),
                ...
                let temp_owl__x984 = { arc_clone(&owl__x963) };
                let owl__x984 = arc_clone(&temp_owl__x984);
                let temp_owl__x986 = { arc_clone(&owl__x898) };
                ...
                let temp_owl__x1000 = { arc_clone(&owl__x926) };
                let owl__x1000 = arc_clone(&temp_owl__x1000);
                let temp_owl__x1002 = { arc_clone(&owl__x979) };
                ...
                let owl__x1011 = arc_new(temp_owl__x1011);
                let temp_owl__x1012 = { arc_clone(&owl__x1011) };
                let owl__x1012 = arc_clone(&temp_owl__x1012);
                let temp_owl__x1018 = { arc_clone(&owl__x987) };
                let owl__x1018 = arc_clone(&temp_owl__x1018);
                let temp_owl__x1020 = { arc_clone(&owl__x1012) };
                let owl__x1020 = arc_clone(&temp_owl__x1020);
                let temp_owl__x1022 = { arc_clone(&owl__x1007) };
                let owl__x1022 = arc_clone(&temp_owl__x1022);
                let temp_owl__x1023 = {
                    match owl_enc_st_aead(
                        vec_as_slice(&(*arc_clone(&owl__x1018))),
                ...
                let owl__x1023 = arc_clone(&temp_owl__x1023);
                let temp_owl__x1036 = { arc_clone(&owl__x1007) };
                let owl__x1036 = arc_clone(&temp_owl__x1036);
                let temp_owl__x1038 = { arc_clone(&owl__x1023) };
                let owl__x1038 = arc_clone(&temp_owl__x1038);
                let temp_owl__x1040 = {
                owl_concat(
                    vec_as_slice(&(*arc_clone(&owl__x1036))),
                    vec_as_slice(&(*arc_clone(&owl__x1038))),
                )
                };
                let owl__x1040 = arc_new(temp_owl__x1040);
                let temp_owl__x1042 = { owl_crh(vec_as_slice(&(*arc_clone(&owl__x1040)))) };
                let owl__x1042 = arc_clone(&temp_owl__x1042);
                let temp_owl__x1043 = { arc_clone(&owl__x1042) };
                let owl__x1043 = arc_clone(&temp_owl__x1043);
                let (temp_owl__x1045, Tracked(itree)): (
                    _,
...
, self.owl_get_sender_r(mut_state) )
                ...
                let owl__x1045 = arc_clone(&temp_owl__x1045);
                let temp_owl__x1049 = { owl_msg2_tag_value() };
                let owl__x1049 = arc_new(temp_owl__x1049);
                let temp_owl__x1050 = { arc_clone(&owl__x1049) };
                let owl__x1050 = arc_clone(&temp_owl__x1050);
                let temp_owl__x1063 = { owl_mac1() };
                let owl__x1063 = arc_new(temp_owl__x1063);
                let temp_owl__x1065 = { arc_clone(&owl_dhpk_S_init874) };
                let owl__x1065 = arc_clone(&temp_owl__x1065);
                let temp_owl__x1067 = {
                owl_concat(
                    vec_as_slice(&(*arc_clone(&owl__x1063))),
                    vec_as_slice(&(*arc_clone(&owl__x1065))),
                )
                };
                let owl__x1067 = arc_new(temp_owl__x1067);
                let temp_owl__x1069 = { owl_crh(vec_as_slice(&(*arc_clone(&owl__x1067)))) };
                let owl__x1069 = arc_clone(&temp_owl__x1069);
                let temp_owl__x1070 = { arc_clone(&owl__x1069) };
                let owl__x1070 = arc_clone(&temp_owl__x1070);
                let temp_owl__x1083 = { arc_clone(&owl__x1070) };
                let owl__x1083 = arc_clone(&temp_owl__x1083);
                let temp_owl__x1089 = { arc_clone(&owl__x1050) };
                let owl__x1089 = arc_clone(&temp_owl__x1089);
                let temp_owl__x1091 = { arc_clone(&owl__x1045) };
                let owl__x1091 = arc_clone(&temp_owl__x1091);
                let temp_owl__x1092 = {
                owl_concat(
                    vec_as_slice(&(*arc_clone(&owl__x1089))),
                    vec_as_slice(&(*arc_clone(&owl__x1091))),
                )
                };
                let owl__x1092 = arc_new(temp_owl__x1092);
                let temp_owl__x1094 = { arc_clone(&owl_msg2_receiver873) };
                ...
                let owl__x1095 = arc_new(temp_owl__x1095);
                let temp_owl__x1097 = { arc_clone(&owl__x893) };
                let owl__x1097 = arc_clone(&temp_owl__x1097);
                let temp_owl__x1098 = {
                owl_concat(
                    vec_as_slice(&(*arc_clone(&owl__x1095))),
                    vec_as_slice(&(*arc_clone(&owl__x1097))),
                )
                };
                let owl__x1098 = arc_new(temp_owl__x1098);
                let temp_owl__x1100 = { arc_clone(&owl__x1023) };
                let owl__x1100 = arc_clone(&temp_owl__x1100);
                let temp_owl__x1101 = {
                owl_concat(
                    vec_as_slice(&(*arc_clone(&owl__x1098))),
                    vec_as_slice(&(*arc_clone(&owl__x1100))),
                )
                };
                let owl__x1101 = arc_new(temp_owl__x1101);
                let temp_owl__x1102 = {
                owl_mac(
                    vec_as_slice(&(*arc_clone(&owl__x1083))),
                    vec_as_slice(&(*arc_clone(&owl__x1101))),
                )
                };
                let owl__x1102 = arc_clone(&temp_owl__x1102);
                let temp_owl__x1106 = { owl_zeros_16() };
                let owl__x1106 = arc_new(temp_owl__x1106);
                let temp_owl__x1107 = { arc_clone(&owl__x1106) };
                let owl__x1107 = arc_clone(&temp_owl__x1107);
                let temp_owl__x1132 = { arc_clone(&owl__x1050) };
                let owl__x1132 = arc_clone(&temp_owl__x1132);
                let temp_owl__x1134 = { arc_clone(&owl__x1045) };
                let owl__x1134 = arc_clone(&temp_owl__x1134);
                let temp_owl__x1136 = { arc_clone(&owl_msg2_receiver873) };
                let owl__x1136 = arc_clone(&temp_owl__x1136);
                let temp_owl__x1138 = { arc_clone(&owl__x893) };
                let owl__x1138 = arc_clone(&temp_owl__x1138);
                let temp_owl__x1140 = { arc_clone(&owl__x1023) };
                let owl__x1140 = arc_clone(&temp_owl__x1140);
                let temp_owl__x1142 = { arc_clone(&owl__x1102) };
                let owl__x1142 = arc_clone(&temp_owl__x1142);
                let temp_owl__x1144 = { arc_clone(&owl__x1107) };
                let owl__x1144 = arc_clone(&temp_owl__x1144);
                let temp_owl__x1146 = {
                owl_msg2 {
                    owl__msg2_tag: clone_vec_u8(&*arc_clone(&owl__x1132)),
                    owl__msg2_sender: clone_vec_u8(&*arc_clone(&owl__x1134)),
                    owl__msg2_receiver: clone_vec_u8(&*arc_clone(&owl__x1136)),
                    owl__msg2_ephemeral: clone_vec_u8(&*arc_clone(&owl__x1138)),
                    owl__msg2_empty: clone_vec_u8(&*arc_clone(&owl__x1140)),
                    owl__msg2_mac1: clone_vec_u8(&*arc_clone(&owl__x1142)),
                    owl__msg2_mac2: clone_vec_u8(&*arc_clone(&owl__x1144)),
                }
                };
                let owl__x1146 = temp_owl__x1146;
                let temp_owl__x1147 = { owl__x1146 };
                let owl__x1147 = temp_owl__x1147;
                let temp_owl__x1151 = { owl__x1147 };
                let owl__x1151 = temp_owl__x1151;
                let temp_owl__x1152 = {
                owl_output::<(Seq<u8>, state_Responder)>(
                    Tracked(&mut itree),
                    vec_as_slice(&(serialize_owl_msg2(&owl__x1151))),
                    &Initiator_addr(),
                    &Responder_addr(),
                    obuf
                )
                };
                let owl__x1152 = temp_owl__x1152;
                let temp_owl__x1157 = { arc_clone(&owl__x971) };
                ...
                let owl_transp_T1217 = owl_extract_expand_to_len(
                    0 + key_size() + key_size(),
                    vec_as_slice(&(*arc_clone(&owl__x1157))),
                    vec_as_slice(&(*arc_clone(&owl__x1159))),
                );
                let temp_owl__x1160 = {
                arc_new(
                    slice_to_vec(
                        slice_subrange(vec_as_slice(&*owl_transp_T1217), 0, 0 + key_size()),
                    ),
                )
                };
                let owl__x1160 = arc_clone(&temp_owl__x1160);
                let temp_owl__x1165 = { arc_clone(&owl__x971) };
                ...
                let owl__x1167 = arc_new(temp_owl__x1167);
                let temp_owl__x1168 = {
                arc_new(
                    slice_to_vec(
                        slice_subrange(
                            vec_as_slice(&*owl_transp_T1217),
                            0 + key_size(),
                            0 + key_size() + key_size(),
                        ),
                    ),
                ...
                let owl__x1168 = arc_clone(&temp_owl__x1168);
                let temp_owl__x1190 = { arc_clone(&owl_msg2_receiver873) };
                let owl__x1190 = arc_clone(&temp_owl__x1190);
                let temp_owl__x1192 = { arc_clone(&owl__x1045) };
                let owl__x1192 = arc_clone(&temp_owl__x1192);
                let temp_owl__x1194 = { arc_clone(&owl__x883) };
                let owl__x1194 = arc_clone(&temp_owl__x1194);
                let temp_owl__x1196 = { arc_clone(&owl__x893) };
                let owl__x1196 = arc_clone(&temp_owl__x1196);
                let temp_owl__x1198 = { arc_clone(&owl__x1160) };
                let owl__x1198 = arc_clone(&temp_owl__x1198);
                let temp_owl__x1200 = { arc_clone(&owl__x1168) };
                let owl__x1200 = arc_clone(&temp_owl__x1200);
                let temp_owl__x1202 = {
                owl_transp_keys {
                    owl__transp_keys_initiator: clone_vec_u8(&*arc_clone(&owl__x1190)),
                    owl__transp_keys_responder: clone_vec_u8(&*arc_clone(&owl__x1192)),
                    owl__transp_keys_init_ephemeral: clone_vec_u8(&*arc_clone(&owl__x1194)),
                    owl__transp_keys_resp_ephemeral: clone_vec_u8(&*arc_clone(&owl__x1196)),
                    owl__transp_keys_T_init_send: clone_vec_u8(&*arc_clone(&owl__x1198)),
                    owl__transp_keys_T_resp_send: clone_vec_u8(&*arc_clone(&owl__x1200)),
                }
                };
                let owl__x1202 = temp_owl__x1202;
                let temp_owl__x1203 = { owl__x1202 };
                let owl__x1203 = temp_owl__x1203;
                let temp_owl__x1206 = { owl__x1203 };
                let owl__x1206 = temp_owl__x1206;
                let temp_owl__x1207 = { owl__x1206 };
                let owl__x1207 = temp_owl__x1207;
                (owl__x1207, Tracked(itree))
            }
        };
        Ok(res_inner)
    }
            ...
            ),
    {
        ...
        let res_inner = {
            ...
            let (temp_owl_inp1226, owl__1225) = owl_input::<(Option<Seq<u8>>, state_Responder)>(
                Tracked(&mut itree),
                ibuf
            );
            let owl_inp1226 = arc_new(temp_owl_inp1226);
            let temp_owl__x1519 = { arc_clone(&owl_inp1226) };
            let owl__x1519 = arc_clone(&temp_owl__x1519);
            if let Some(parseval) = parse_owl_msg1(vec_as_slice(&(*arc_clone(&owl__x1519)))) {
                let owl_msg1_tag1234 = arc_new(parseval.owl__msg1_tag);
                let owl_msg1_sender1233 = arc_new(parseval.owl__msg1_sender);
                let owl_msg1_ephemeral_1232 = arc_new(parseval.owl__msg1_ephemeral);
                let owl_msg1_static1231 = arc_new(parseval.owl__msg1_static);
                let owl_msg1_timestamp1230 = arc_new(parseval.owl__msg1_timestamp);
                let owl_msg1_mac11229 = arc_new(parseval.owl__msg1_mac1);
                let owl_msg1_mac21228 = arc_new(parseval.owl__msg1_mac2);
                {
                    let temp_owl__x1514 = { arc_clone(&owl_msg1_sender1233) };
                    let owl__x1514 = arc_clone(&temp_owl__x1514);
                    let temp_owl__x1515 = { vec_length(&(*arc_clone(&owl__x1514))) };
                    let owl__x1515 = temp_owl__x1515;
                    let temp_owl__x1517 = { 4 };
                    let owl__x1517 = temp_owl__x1517;
                    let temp_owl__x1518 = { owl__x1515 == owl__x1517 };
                    let owl__x1518 = temp_owl__x1518;
                    if owl__x1518 {
                        let temp_owl__x1507 = { arc_clone(&owl_msg1_ephemeral_1232) };
                        let owl__x1507 = arc_clone(&temp_owl__x1507);
                        let temp_owl__x1508 = {
                        owl_is_group_elem(vec_as_slice(&(*arc_clone(&owl__x1507))))
                        };
                        let owl__x1508 = temp_owl__x1508;
                        if owl__x1508 {
                            let temp_owl__x1241 = { owl_construction() };
                            let owl__x1241 = arc_new(temp_owl__x1241);
                            let temp_owl__x1243 = {
                            owl_crh(vec_as_slice(&(*arc_clone(&owl__x1241))))
                            };
                            let owl__x1243 = arc_clone(&temp_owl__x1243);
                            let temp_owl__x1244 = { arc_clone(&owl__x1243) };
                            let owl__x1244 = arc_clone(&temp_owl__x1244);
                            let temp_owl__x1257 = { arc_clone(&owl__x1244) };
                            let owl__x1257 = arc_clone(&temp_owl__x1257);
                            let temp_owl__x1259 = { owl_identifier() };
                            let owl__x1259 = arc_new(temp_owl__x1259);
                            let temp_owl__x1261 = {
                            owl_concat(
                                vec_as_slice(&(*arc_clone(&owl__x1257))),
                                vec_as_slice(&(*arc_clone(&owl__x1259))),
                            )
                            };
                            let owl__x1261 = arc_new(temp_owl__x1261);
                            let temp_owl__x1263 = {
                            owl_crh(vec_as_slice(&(*arc_clone(&owl__x1261))))
                            };
                            let owl__x1263 = arc_clone(&temp_owl__x1263);
                            let temp_owl__x1264 = { arc_clone(&owl__x1263) };
                            let owl__x1264 = arc_clone(&temp_owl__x1264);
                            let temp_owl__x1280 = { arc_clone(&owl__x1264) };
                            let owl__x1280 = arc_clone(&temp_owl__x1280);
                            let temp_owl__x1282 = { arc_clone(&self.owl_S_resp) };
                            let owl__x1282 = arc_clone(&temp_owl__x1282);
                            let temp_owl__x1284 = {
                            owl_dhpk(vec_as_slice(&(*arc_clone(&owl__x1282))))
                            };
                            let owl__x1284 = arc_clone(&temp_owl__x1284);
                            let temp_owl__x1286 = {
                            owl_concat(
                                vec_as_slice(&(*arc_clone(&owl__x1280))),
                                vec_as_slice(&(*arc_clone(&owl__x1284))),
                            )
                            };
                            let owl__x1286 = arc_new(temp_owl__x1286);
                            let temp_owl__x1288 = {
                            owl_crh(vec_as_slice(&(*arc_clone(&owl__x1286))))
                            };
                            let owl__x1288 = arc_clone(&temp_owl__x1288);
                            let temp_owl__x1289 = { arc_clone(&owl__x1288) };
                            let owl__x1289 = arc_clone(&temp_owl__x1289);
                            let temp_owl__x1295 = { arc_clone(&owl_msg1_ephemeral_1232) };
                            let owl__x1295 = arc_clone(&temp_owl__x1295);
                            let temp_owl__x1296 = { arc_clone(&owl__x1295) };
                            let owl__x1296 = arc_clone(&temp_owl__x1296);
                            let temp_owl__x1301 = { arc_clone(&owl__x1244) };
                            let owl__x1301 = arc_clone(&temp_owl__x1301);
                            let temp_owl__x1303 = { arc_clone(&owl__x1296) };
                            let owl__x1303 = arc_clone(&temp_owl__x1303);
                            let owl_msg1_C11527 = owl_extract_expand_to_len(
                                0 + nonce_size(),
                                vec_as_slice(&(*arc_clone(&owl__x1301))),
                                vec_as_slice(&(*arc_clone(&owl__x1303))),
                            );
                            let temp_owl__x1304 = {
                            arc_new(
                                slice_to_vec(
                                    slice_subrange(
                                        vec_as_slice(&*owl_msg1_C11527),
                                        0,
                                        0 + nonce_size(),
                                    ),
                                ),
                            ...
                            let temp_owl__x1317 = { arc_clone(&owl__x1289) };
                            let owl__x1317 = arc_clone(&temp_owl__x1317);
                            let temp_owl__x1319 = { arc_clone(&owl__x1296) };
                            let owl__x1319 = arc_clone(&temp_owl__x1319);
                            let temp_owl__x1321 = {
                            owl_concat(
                                vec_as_slice(&(*arc_clone(&owl__x1317))),
                                vec_as_slice(&(*arc_clone(&owl__x1319))),
                            )
                            };
                            let owl__x1321 = arc_new(temp_owl__x1321);
                            let temp_owl__x1323 = {
                            owl_crh(vec_as_slice(&(*arc_clone(&owl__x1321))))
                            };
                            let owl__x1323 = arc_clone(&temp_owl__x1323);
                            let temp_owl__x1324 = { arc_clone(&owl__x1323) };
                            let owl__x1324 = arc_clone(&temp_owl__x1324);
                            let temp_owl__x1334 = { arc_clone(&owl__x1296) };
                            let owl__x1334 = arc_clone(&temp_owl__x1334);
                            let temp_owl__x1336 = { arc_clone(&self.owl_S_resp) };
                            let owl__x1336 = arc_clone(&temp_owl__x1336);
                            let temp_owl__x1338 = {
                            owl_dh_combine(
                                vec_as_slice(&(*arc_clone(&owl__x1334))),
                                vec_as_slice(&(*arc_clone(&owl__x1336))),
                            )
                            };
                            let owl__x1338 = arc_clone(&temp_owl__x1338);
                            let temp_owl__x1339 = { arc_clone(&owl__x1338) };
                            let owl__x1339 = arc_clone(&temp_owl__x1339);
                            let temp_owl__x1344 = { arc_clone(&owl__x1304) };
                            let owl__x1344 = arc_clone(&temp_owl__x1344);
                            let temp_owl__x1346 = { arc_clone(&owl__x1339) };
                            let owl__x1346 = arc_clone(&temp_owl__x1346);
                            let owl_msg1_C21528 = owl_extract_expand_to_len(
                                0 + nonce_size() + key_size(),
                                vec_as_slice(&(*arc_clone(&owl__x1344))),
                                vec_as_slice(&(*arc_clone(&owl__x1346))),
                            );
                            let temp_owl__x1347 = {
                            arc_new(
                                slice_to_vec(
                                    slice_subrange(
                                        vec_as_slice(&*owl_msg1_C21528),
                                        0,
                                        0 + nonce_size(),
                                    ),
                                ),
                            ...
                            let temp_owl__x1352 = { arc_clone(&owl__x1304) };
                            let owl__x1352 = arc_clone(&temp_owl__x1352);
                            let temp_owl__x1354 = { arc_clone(&owl__x1339) };
                            ...
                            let temp_owl__x1497 = { arc_clone(&owl__x1355) };
                            let owl__x1497 = arc_clone(&temp_owl__x1497);
                            let temp_owl__x1499 = { arc_clone(&owl_msg1_static1231) };
                            let owl__x1499 = arc_clone(&temp_owl__x1499);
                            let temp_owl__x1501 = { arc_clone(&owl__x1324) };
                            ...
                            let owl__x1503 = arc_new(temp_owl__x1503);
                            let temp_owl__x1504 = {
                            owl_dec_st_aead(
                                vec_as_slice(&(*arc_clone(&owl__x1497))),
                                vec_as_slice(&(*arc_clone(&owl__x1499))),
                                vec_as_slice(&(*arc_clone(&owl__x1503))),
                                vec_as_slice(&(*arc_clone(&owl__x1501))),
                            )
                            };
                            let owl__x1504 = temp_owl__x1504;
                            let temp_owl_caseval1526 = { owl__x1504 };
                            let owl_caseval1526 = temp_owl_caseval1526;
                            match owl_caseval1526 {
                                None => {
                                    let temp_owl__x1360 = { None };
                                    let owl__x1360 = temp_owl__x1360;
                                    (owl__x1360, Tracked(itree))
                                },
                                Some(temp_owl_msg1_static_dec1361) => {
                                    let owl_msg1_static_dec1361 = arc_clone(
                                        &temp_owl_msg1_static_dec1361,
                                    );
                                    let temp_owl__x1365 = { arc_clone(&owl_msg1_static_dec1361) };
                                    let owl__x1365 = arc_clone(&temp_owl__x1365);
                                    let (temp_owl__x1366, Tracked(itree)): (
                                        _,
                                        Tracked<
                                            ITreeToken<
                                                (Option<Seq<u8>>, state_Responder),
...
, *mut_state
, checkpk_resp_spec(*self, *mut_state, (&owl__x1365).dview())
, self.owl_checkpk_resp(mut_state, arc_clone(&owl__x1365)) )
                                    };
                                    let owl__x1366 = temp_owl__x1366;
                                    let temp_owl__x1494 = { owl__x1366 };
                                    let owl__x1494 = temp_owl__x1494;
                                    let temp_owl__x1495 = { owl__x1494 };
                                    let owl__x1495 = temp_owl__x1495;
                                    let temp_owl_caseval1525 = { owl__x1495 };
                                    let owl_caseval1525 = temp_owl_caseval1525;
                                    match owl_caseval1525 {
                                        None => {
                                            let temp_owl__x1368 = { None };
                                            let owl__x1368 = temp_owl__x1368;
                                            (owl__x1368, Tracked(itree))
                                        },
                                        Some(temp_owl_ss_S_init_S_resp_1369) => {
                                            let owl_ss_S_init_S_resp_1369 = arc_clone(
                                                &temp_owl_ss_S_init_S_resp_1369,
                                            );
                                            let temp_owl__x1492 = {
                                            arc_clone(&owl_ss_S_init_S_resp_1369)
                                            };
                                            let owl__x1492 = arc_clone(&temp_owl__x1492);
                                            let temp_owl__x1375 = {
                                            arc_clone(&owl_msg1_static_dec1361)
                                            };
                                            let owl__x1375 = arc_clone(&temp_owl__x1375);
                                            let temp_owl__x1376 = { arc_clone(&owl__x1375) };
                                            let owl__x1376 = arc_clone(&temp_owl__x1376);
                                            let temp_owl__x1389 = { arc_clone(&owl__x1324) };
                                            let owl__x1389 = arc_clone(&temp_owl__x1389);
                                            let temp_owl__x1391 = { arc_clone(&owl_msg1_static1231)
                                            };
                                            let owl__x1391 = arc_clone(&temp_owl__x1391);
                                            let temp_owl__x1393 = {
                                            owl_concat(
                                                vec_as_slice(&(*arc_clone(&owl__x1389))),
                                                vec_as_slice(&(*arc_clone(&owl__x1391))),
                                            )
                                            };
                                            let owl__x1393 = arc_new(temp_owl__x1393);
                                            let temp_owl__x1395 = {
                                            owl_crh(vec_as_slice(&(*arc_clone(&owl__x1393))))
                                            };
                                            let owl__x1395 = arc_clone(&temp_owl__x1395);
                                            let temp_owl__x1396 = { arc_clone(&owl__x1395) };
                                            let owl__x1396 = arc_clone(&temp_owl__x1396);
                                            let temp_owl__x1401 = { arc_clone(&owl__x1347) };
                                            let owl__x1401 = arc_clone(&temp_owl__x1401);
                                            let temp_owl__x1403 = { arc_clone(&owl__x1492) };
                                            let owl__x1403 = arc_clone(&temp_owl__x1403);
                                            let owl_msg1_C31529 = owl_extract_expand_to_len(
                                                0 + nonce_size() + key_size(),
                                                vec_as_slice(&(*arc_clone(&owl__x1401))),
                                                vec_as_slice(&(*arc_clone(&owl__x1403))),
                                            );
                                            let temp_owl__x1404 = {
                                            arc_new(
                                                slice_to_vec(
                                                    slice_subrange(
                                                        vec_as_slice(&*owl_msg1_C31529),
                                                        0,
                                                        0 + nonce_size(),
                                                    ),
                                                ),
                                            ...
                                            let temp_owl__x1409 = { arc_clone(&owl__x1347) };
                                            let owl__x1409 = arc_clone(&temp_owl__x1409);
                                            let temp_owl__x1411 = { arc_clone(&owl__x1492) };
                                            ...
                                            let temp_owl__x1484 = { arc_clone(&owl__x1412) };
                                            let owl__x1484 = arc_clone(&temp_owl__x1484);
                                            let temp_owl__x1486 = {
                                            arc_clone(&owl_msg1_timestamp1230)
                                            };
                                            let owl__x1486 = arc_clone(&temp_owl__x1486);
                                            let temp_owl__x1488 = { arc_clone(&owl__x1396) };
                                            ...
                                            let temp_owl_caseval1524 = { owl__x1491 };
                                            let owl_caseval1524 = temp_owl_caseval1524;
                                            match owl_caseval1524 {
                                                None => {
                                                    let temp_owl__x1417 = { None };
                                                    let owl__x1417 = temp_owl__x1417;
                                                    (owl__x1417, Tracked(itree))
                                                },
                                                Some(temp_owl_msg1_timestamp_dec1418) => {
                                                    let owl_msg1_timestamp_dec1418 = arc_clone(
                                                        &temp_owl_msg1_timestamp_dec1418,
                                                    );
                                                    let temp_owl__x1431 = { arc_clone(&owl__x1396)
                                                    };
                                                    ...
                                                    let temp_owl__x1438 = { arc_clone(&owl__x1437)
                                                    };
                                                    let owl__x1438 = arc_clone(&temp_owl__x1438);
                                                    let temp_owl__x1457 = { arc_clone(&owl__x1404)
                                                    };
                                                    let owl__x1457 = arc_clone(&temp_owl__x1457);
                                                    let temp_owl__x1459 = { arc_clone(&owl__x1438)
                                                    };
                                                    let owl__x1459 = arc_clone(&temp_owl__x1459);
                                                    let temp_owl__x1461 = { arc_clone(&owl__x1296)
                                                    };
                                                    let owl__x1461 = arc_clone(&temp_owl__x1461);
                                                    let temp_owl__x1463 = { arc_clone(&owl__x1376)
                                                    };
                                                    let owl__x1463 = arc_clone(&temp_owl__x1463);
                                                    let temp_owl__x1465 = {
                                                    arc_clone(&owl_msg1_sender1233)
                                                    };
                                                    let owl__x1465 = arc_clone(&temp_owl__x1465);
                                                    let temp_owl__x1467 = {
                                                    owl_responder_msg1_val {
                                                        owl__responder_msg1_C3: clone_vec_u8(
                                                            &*arc_clone(&owl__x1457),
                                                        ),
                                                        owl__responder_msg1_H4: clone_vec_u8(
                                                            &*arc_clone(&owl__x1459),
                                                        ),
                                                        owl__responder_msg1_ephemeral: clone_vec_u8(
                                                            &*arc_clone(&owl__x1461),
                                                        ),
                                                        owl__responder_msg1_sender_pk: clone_vec_u8(
                                                            &*arc_clone(&owl__x1463),
                                                        ),
                                                        owl__responder_msg1_sender: clone_vec_u8(
                                                            &*arc_clone(&owl__x1465),
                                                        ),
                                                    }
                                                    };
                                                    let owl__x1467 = temp_owl__x1467;
                                                    let temp_owl__x1468 = { owl__x1467 };
                                                    let owl__x1468 = temp_owl__x1468;
                                                    let temp_owl__x1475 = { owl__x1468 };
                                                    let owl__x1475 = temp_owl__x1475;
                                                    let temp_owl__x1477 = { owl__x1475 };
                                                    let owl__x1477 = temp_owl__x1477;
                                                    let temp_owl__x1478 = { owl__x1477 };
                                                    let owl__x1478 = temp_owl__x1478;
                                                    let temp_owl__x1481 = { owl__x1478 };
                                                    let owl__x1481 = temp_owl__x1481;
                                                    let temp_owl__x1482 = { Some(owl__x1481) };
                                                    let owl__x1482 = temp_owl__x1482;
                                                    (owl__x1482, Tracked(itree))
                                                },
                                            }
                                        },
                                    }
                ...
                let temp_owl__x1227 = { None };
                let owl__x1227 = temp_owl__x1227;
                (owl__x1227, Tracked(itree))
            }
        };
        Ok(res_inner)
    }
    ...
    pub fn owl_checkpk_resp(
        ...
        Tracked(itree): Tracked<ITreeToken<(Option<Seq<u8>>, state_Responder), Endpoint>>,
        mut_state: &mut state_Responder,
        owl_pk8137: Arc<Vec<u8>>,
    ) -> (res: Result<
        (Option<Arc<Vec<u8>>>, Tracked<ITreeToken<(Option<Seq<u8>>, state_Responder), Endpoint>>),
        OwlError,
    >)
        requires
            itree.view() == checkpk_resp_spec(*self, *old(mut_state), owl_pk8137.dview()),
        ensures
            res.is_Ok() ==> (res.get_Ok_0().1).view().view().results_in(
                (dview_option(res.get_Ok_0().0), *mut_state),
            ),
    {
        ...
        let res_inner = {
            ...
            let pk: [u8; 32] = (&*owl_pk8137).as_slice().try_into().unwrap();
