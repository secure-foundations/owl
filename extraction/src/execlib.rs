...
{
    Rc::new(owl_pke::sign(privkey, msg))
}
...
{
    Rc::new(owl_dhke::ecdh_dhpk(privkey))
}
...
{
    Rc::new(owl_dhke::ecdh_combine(privkey, pubkey))
}
...
{
    Rc::new(owl_hmac::hmac(hmac_mode(), mackey, msg, None))
}
...
{
    Rc::new(owl_pke::encrypt(pubkey, msg))
}
...
{
    Rc::new(owl_pke::decrypt(privkey, ctxt))
}
